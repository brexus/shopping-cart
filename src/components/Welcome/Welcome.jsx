...
export default function Welcome() {
    ...
    return (
        ...
        >
            <div>
                <h1 className="text-white text-center text-8xl font-bold">Welcome</h1>
                <h2 className="text-white text-center text-2xl">buy yourself some clothes...</h2>
            </div>
            ...
            <Link to="/shop">
                <button
                    id="welcome-shop-btn"
                    className={`text-white font-medium text-3xl py-[3px] px-[20px] rounded-3xl border-white border-[2px] mt-5 
